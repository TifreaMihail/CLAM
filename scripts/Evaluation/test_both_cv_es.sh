...
#SBATCH --output=/home/mcs001/20181133/CLAM/job_logs/gabmil/BOTH_gabmil_test_%j.txt
...
results_subdir="/home/mcs001/20181133/CLAM/results/TEST_WSI_5_ES/BOTH/${norm_code}_${skip_code}"
