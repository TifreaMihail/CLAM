...
#SBATCH --job-name=test_abmil_CAM16_BLOCK
#SBATCH --output=/home/mcs001/20181133/CLAM/job_logs/abmil/test.txt
...
top_configs[1]="1e-3 1e-4 0 False False"
top_configs[2]="1e-3 1e-3 0 False False"
top_configs[3]="1e-4 1e-3 0 False False"
top_configs[4]="1e-3 1e-5 0 False False"
top_configs[5]="1e-4 1e-4 0 False False"
...
for i in {1..5}; do
  ...
  results_subdir="/home/mcs001/20181133/CLAM/results/TEST_CV_ES/ABMIL/${norm_code}_${skip_code}"
