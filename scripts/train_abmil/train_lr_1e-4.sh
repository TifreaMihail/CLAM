...
#SBATCH --job-name=train_abmil_CAM16_lr_1e-24
#SBATCH --output=/home/mcs001/20181133/CLAM/job_logs/abmil/train_abmil_lr1e-4%j.txt
...
for rg in "${regularizations[@]}"; do
  ...
  python /home/mcs001/20181133/CLAM/main.py \
    ...
    --results_dir /home/mcs001/20181133/CLAM/results/abmil_final_pl1 \
