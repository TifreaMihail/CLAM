...
#SBATCH --job-name=train_gabmil_CAM16_lr_1e-3
#SBATCH --output=/home/mcs001/20181133/CLAM/job_logs/gabmil/WINDOW_gabmil_lr1e-3%j_window.txt
  ...
  for use_skip in True False; do
    for rg in "${regularizations[@]}"; do
      for ws in "${window_sizes[@]}"; do
        ...
        results_subdir="/home/mcs001/20181133/CLAM/results/TRAIN/BLOCK/${norm_code}_${skip_code}"
