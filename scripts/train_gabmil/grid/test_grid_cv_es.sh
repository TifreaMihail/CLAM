...
#SBATCH --output=/home/mcs001/20181133/CLAM/job_logs/gabmil/GRID_gabmil_test.txt
...
# top_configs[1]="1e-3 1e-5 4 False True"
# top_configs[2]="1e-3 1e-5 1 False True"
# top_configs[3]="1e-4 1e-4 4 False True"
# top_configs[4]="1e-4 1e-5 1 True False"
# top_configs[5]="1e-3 1e-3 1 False True"

# Hyperparameter tuning
declare -A top_configs
top_configs[1]="1e-3 1e-5 4 False True"
top_configs[2]="1e-4 1e-4 4 False True"
top_configs[3]="1e-4 1e-5 4 False True"
top_configs[4]="1e-3 1e-3 2 False True"
top_configs[5]="1e-4 1e-3 4 False True"
...
for i in {1..5}; do
  ...
  results_subdir="/home/mcs001/20181133/CLAM/results/TEST_CV_ES/GRID/${norm_code}_${skip_code}"
