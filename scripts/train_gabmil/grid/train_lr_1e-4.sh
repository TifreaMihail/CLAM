...
#SBATCH --job-name=train_abmil_CAM16_lr_1e-4
#SBATCH --output=/home/mcs001/20181133/CLAM/job_logs/gabmil/WINDOW_gabmil_lr1e-4%j_both.txt
  ...
  for use_skip in True False; do
    for rg in "${regularizations[@]}"; do
      for ws in "${window_sizes[@]}"; do
        ...
        results_subdir="/home/mcs001/20181133/CLAM/results/TRAIN/GRID/${norm_code}_${skip_code}"
