...
#SBATCH --output=/home/mcs001/20181133/CLAM/job_logs/gabmil/BOTH_gabmil_ws1.txt
...
declare -A top_configs
top_configs[1]="1e-3 1e-3 1 False True"
top_configs[2]="1e-3 1e-3 2 False True"
...
for i in {1..3}; do
  ...
  results_subdir="/home/mcs001/20181133/CLAM/results/TEST_WS1_CV/BOTH/${norm_code}_${skip_code}"
