...
#SBATCH --output=/home/mcs001/20181133/CLAM/job_logs/gabmil/GRID_gabmil_ws1.txt
...
for i in {1..3}; do
  ...
  results_subdir="/home/mcs001/20181133/CLAM/results/TEST_WS1_CV/GRID/${norm_code}_${skip_code}"
